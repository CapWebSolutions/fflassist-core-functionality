 ...
 * @subpackage Fflassist_Core_Functionality/admin
 */
 ...
 */
class Fflassist_Core_Functionality_Admin {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $fflassist_core_functionality       The name of this plugin.
